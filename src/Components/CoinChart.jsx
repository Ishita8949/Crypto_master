...
const CoinChart = ({currency}) => {
    ...
    const CoinChartData=async()=>{
        try {
            const { data } = await axios.get(`${Baseurl1}/coins/${id}/market_chart?vs_currency=${currency}&days=${days}&x_cg_demo_api_key=CG-GbqKvC1ihcNmZZtGoJKgopgV`)
